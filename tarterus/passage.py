...
def dispatch_passage(engine, element, dice):
    ...
    # draw room instead of passage. needs to know origin type.
    # NOTE: is there utility from other table entries knowing origin? like
    # NOTE: door? Would like to have consistent method signatures
    elif die_roll <= 19:
        passage_table_15_19(engine, origin, x, y, direction,
                            width, psquare, dice)
    else:
